...
User.find_or_create_by!(email: "2tailscat@example.com") do |user|
  user.name = "猫又"
  user.password = "123456"
...
Game.find_or_create_by!(id: "4") do |game|
  game.title = "魔王の冒険"
  game.image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1-4.png"), filename:"sample-post1-4.png")
  game.caption = "今度はワシが主役！"
  game.user_id = 1
end
...
Game.find_or_create_by!(id: "6") do |game|
  game.title = "妖精の国"
...
Game.find_or_create_by!(id: "7") do |game|
  game.title = "スライムの冒険"
  game.image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1-3.png"), filename:"sample-post1-3.png")
  game.caption = "魔王軍3度目の正直！　……そろそろ無理がある？"
  game.user_id = 1
end
...
Tag.find_or_create_by!(id: "8") do |tag|
  tag.name = "ホラー"
end
...
GameTag.find_or_create_by!(id: "1") do |tag|
  tag.game_id = "1"
  tag.tag_id = "1"
end

GameTag.find_or_create_by!(id: "2") do |tag|
  tag.game_id = "1"
  tag.tag_id = "2"
end

GameTag.find_or_create_by!(id: "3") do |tag|
  tag.game_id = "1"
  tag.tag_id = "3"
end

GameTag.find_or_create_by!(id: "4") do |tag|
  tag.game_id = "2"
  tag.tag_id = "4"
end

GameTag.find_or_create_by!(id: "5") do |tag|
  tag.game_id = "2"
  tag.tag_id = "6"
end
GameTag.find_or_create_by!(id: "6") do |tag|
  tag.game_id = "3"
  tag.tag_id = "5"
end

GameTag.find_or_create_by!(id: "7") do |tag|
  tag.game_id = "4"
  tag.tag_id = "1"
end

GameTag.find_or_create_by!(id: "8") do |tag|
  tag.game_id = "4"
  tag.tag_id = "2"
end

GameTag.find_or_create_by!(id: "9") do |tag|
  tag.game_id = "4"
  tag.tag_id = "3"
end

GameTag.find_or_create_by!(id: "10") do |tag|
  tag.game_id = "5"
  tag.tag_id = "7"
end

GameTag.find_or_create_by!(id: "11") do |tag|
  tag.game_id = "5"
  tag.tag_id = "8"
end

GameTag.find_or_create_by!(id: "12") do |tag|
  tag.game_id = "6"
  tag.tag_id = "3"
end

GameTag.find_or_create_by!(id: "13") do |tag|
  tag.game_id = "6"
  tag.tag_id = "7"
end

GameTag.find_or_create_by!(id: "14") do |tag|
  tag.game_id = "6"
  tag.tag_id = "1"
end

GameTag.find_or_create_by!(id: "15") do |tag|
  tag.game_id = "7"
  tag.tag_id = "1"
end

GameTag.find_or_create_by!(id: "16") do |tag|
  tag.game_id = "7"
  tag.tag_id = "2"
end

GameTag.find_or_create_by!(id: "17") do |tag|
  tag.game_id = "7"
  tag.tag_id = "3"
end
